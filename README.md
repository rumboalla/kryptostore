...
Import the library
```kotlin
implementation("com.github.rumboalla.kryptostore:core:0.1.6")
```
Use preferences
```kotlin
...
```kotlin
implementation("com.github.rumboalla.kryptostore:gson:0.1.6")
```
...
```kotlin
implementation("com.github.rumboalla.kryptostore:kxs:0.1.6")
```
Use serialized preferences
```kotlin
import android.content.Context
...
```kotlin
implementation("com.github.rumboalla.kryptostore:keystore:0.1.6")
```
...
```kotlin
implementation("com.github.rumboalla.kryptostore:compose:0.1.6")
```
Use it
```kotlin
import android.content.Context
